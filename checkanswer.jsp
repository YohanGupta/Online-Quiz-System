...
<%
  try
  {
	...
	if(rs.next())//if team exists
	{
		...
		System.out.println("get  before correct ans from db");
		rs2=Db.getSelected(con,"select answer from questions where qno="+quesno);
		if(rs2.next())//if question exists
		{
			//get answer
			String correctans=rs2.getString(1);
			System.out.println("correctanswer is="+correctans+" "+ans);
			//compare answers
			...
			String q4="update teams set marks="+marks+" where teamname="+teamno; 
